...
const JSON_PATH = path.join(process.cwd(), 'events-export.json');
const CSV_PATH = path.join(process.cwd(), 'events-export.csv');
...
try {
  ...
  // Optional: Ensure specific order or include specific columns first if needed
  // For now, we'll just convert the Set to an Array
